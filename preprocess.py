...
from datasets import blizzard, ljspeech, trump
...
def preprocess_trump(args):
  in_dir = os.path.join(args.base_dir, 'trump_2hr')
  out_dir = os.path.join(args.base_dir, args.output)
  os.makedirs(out_dir, exist_ok=True)
...
def main():
  ...
  parser.add_argument('--dataset', default='trump', choices=['trump', 'blizzard', 'ljspeech'])
